-- Update lavender template: logo over banner, no solid purple bar
-- Run with: wrangler d1 execute montessori-db --file=schema/update-template-lavender.sql --remote
